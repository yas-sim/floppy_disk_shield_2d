...
if __name__ == "__main__":
    ...
    parser.add_argument('--high_gain', type=float, required=False, default=2, help='high-speed data separator gain (default: 0, recommend: 0~0.4)')
    parser.add_argument('--low_gain', type=float, required=False, default=1, help='low-speed data separator gain (default: 0, recommend: 0~high_gain)')
